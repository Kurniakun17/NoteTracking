                ...
                VStack(spacing: 32) {
                    HStack(spacing: 16) {
                        NavigationLink(destination: CalendarView()) {
                            SummaryItemView(title: "Scheduled", count: 3, icon: "calendar.circle.fill")
                        }
                        // TODO: kalau berubah dark harus diatur
                        .foregroundColor(.black)
                        
                        NavigationLink(destination: PinnedNotesView()) {
                            SummaryItemView(title: "Pinned", count: 2, icon: "pin.circle.fill")
                        }
                        .foregroundColor(.black)
                    }
                    ...
                    HStack(spacing: 16) {
                        NavigationLink(destination: AllNotesView()) {
                            SummaryItemView(title: "All Notes", count: 4, icon: "tray.circle.fill")
                        }
                        .foregroundColor(.black)
                        
                        NavigationLink(destination: HabitEntries()) {
                            SummaryItemView(title: "Habit Entries", count: 5, icon: "pencil.circle.fill")
                        }
                        .foregroundColor(.black)
                    }
                }
